...
mixin _$Pocket {
  ...
  List<PocketUser> get users => throw _privateConstructorUsedError;
...
abstract class $PocketCopyWith<$Res> {
  ...
  $Res call(
      ...
      int level,
      String ownerID,
      List<String> editorID,
      List<String> watcherID,
      List<PocketUser> users,
      String createdAt,
      String updatedAt});
}
...
class _$_Pocket extends _Pocket {
  ...
  final List<PocketUser> _users;
  @override
  List<PocketUser> get users {
  ...
  @override
  String toString() {
    return 'Pocket(id: $id, pocketName: $pocketName, balance: $balance, currency: $currency, icon: $icon, level: $level, ownerID: $ownerID, editorID: $editorID, watcherID: $watcherID, users: $users, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
mixin _$PocketUser {
  ...
  @JsonKey(ignore: true)
  $PocketUserCopyWith<PocketUser> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PocketUserCopyWith<$Res> {
  factory $PocketUserCopyWith(
          PocketUser value, $Res Function(PocketUser) then) =
      _$PocketUserCopyWithImpl<$Res, PocketUser>;
  @useResult
  $Res call({String id, String name, String role});
}

/// @nodoc
class _$PocketUserCopyWithImpl<$Res, $Val extends PocketUser>
    implements $PocketUserCopyWith<$Res> {
  _$PocketUserCopyWithImpl(this._value, this._then);
